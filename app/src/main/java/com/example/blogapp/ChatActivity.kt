...
class ChatActivity : AppCompatActivity() {
    ...
    fun addToChatList(currentUserUid: String, otherUserUid: String) {
        ...
        val currentUserRef = dbRef.child("users").child(currentUserUid).child("chatWith").child(otherUserUid)
        currentUserRef.setValue(true)

        val otherUserRef = dbRef.child("users").child(otherUserUid).child("chatWith").child(currentUserUid)
